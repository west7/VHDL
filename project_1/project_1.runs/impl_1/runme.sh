...
HD_PWD='C:/Users/guilh/rea de Trabalho/UnB/4 semestre/PED - Diogo/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SomadorSubtrator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SomadorSubtrator.tcl -notrace
