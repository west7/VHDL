...
HD_PWD='C:/Users/guilh/rea de Trabalho/UnB/4 semestre/PED - Diogo/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SomadorSubtrator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SomadorSubtrator.tcl
